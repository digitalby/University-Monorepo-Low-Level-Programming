// SP_LR12_PART2.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "SP_LR12_PART2.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SPLR12PART2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SPLR12PART2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SPLR12PART2));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_SPLR12PART2);
